      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br />a dedicated <span className="purple">AI engineering</span>, navigating the exciting intersection of <strong>AI and business strategies</strong>. My journey integrates applied mathematics, machine learning, a lot of coding, and a knack for translating complex ideas into actionable AI solutions that meet real-world needs. For me, the goal is always to create tangible value to support your vision and goals.
            <br />
            ...
            <br />
            <br />This portfolio offers a look into my <strong>professional growth</strong> and <strong>personal values</strong>, though it represents only a small part of my journey. Privacy is a key value for me, especially when it comes to confidential client projects and spin-offs. If you’re interested in discussing my experience further, feel free to reach out—I’m always open to exploring if I’m the right fit for your team. Stay tuned, as I’ll soon be adding more of my <strong>generative AI side projects</strong> here as well!
            <br />
